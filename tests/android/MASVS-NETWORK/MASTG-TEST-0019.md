...
> アプリケーションによっては証明書ピン留めのため Burp や OWASP ZAP などのプロキシで動作しないことがあります。このようなシナリオでは、 ["カスタム証明書ストアおよび証明書ピンニングのテスト"](../../../tests/android/MASVS-NETWORK/MASTG-TEST-0022.md) をチェックしてください。
