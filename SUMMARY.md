...
- [テクニック一覧](techniques.md)
  ...
  - Android
    ...
    - [MASTG-TECH-0009 システムログの監視 (Monitoring System Logs)](techniques/android/MASTG-TECH-0009.md)
    - [MASTG-TECH-0013 Android アプリのリバースエンジニアリング (Reverse Engineering Android Apps)](techniques/android/MASTG-TECH-0013.md)
    - [MASTG-TECH-0014 Android での静的解析 (Static Analysis on Android)](techniques/android/MASTG-TECH-0014.md)
    - [MASTG-TECH-0015 Android での動的解析 (Dynamic Analysis on Android)](techniques/android/MASTG-TECH-0015.md)
    - [MASTG-TECH-0016 コードを Smali へ逆アセンブル (Disassembling Code to Smali)](techniques/android/MASTG-TECH-0016.md)
    - [MASTG-TECH-0019 文字列の取得 (Retrieving Strings)](techniques/android/MASTG-TECH-0019.md)
    - [MASTG-TECH-0020 相互参照の取得 (Retrieving Cross References)](techniques/android/MASTG-TECH-0020.md)
    - [MASTG-TECH-0021 情報収集 - API の使用 (Information Gathering - API Usage)](techniques/android/MASTG-TECH-0021.md)
    - [MASTG-TECH-0022 情報収集 - ネットワーク通信 (Information Gathering - Network Communication)](techniques/android/MASTG-TECH-0022.md)
    - [MASTG-TECH-0025 自動静的解析 (Automated Static Analysis)](techniques/android/MASTG-TECH-0025.md)
    - [MASTG-TECH-0026 非ルート化デバイスでの動的解析 (Dynamic Analysis on Non-Rooted Devices)](techniques/android/MASTG-TECH-0026.md)
    - [MASTG-TECH-0027 オープンファイルの取得 (Get Open Files)](techniques/android/MASTG-TECH-0027.md)
    - [MASTG-TECH-0028 オープンコネクションの取得 (Get Open Connections)](techniques/android/MASTG-TECH-0028.md)
    - [MASTG-TECH-0029 ロードされたネイティブライブラリの取得 (Get Loaded Native Libraries)](techniques/android/MASTG-TECH-0029.md)
    ...
    - [MASTG-TECH-0117 AndroidManifest から情報の取得 (Obtaining Information from the AndroidManifest)](techniques/android/MASTG-TECH-0117.md)
    - [MASTG-TECH-0126 アプリパーミッションの取得 (Obtaining App Permissions)](techniques/android/MASTG-TECH-0126.md)
    - [MASTG-TECH-0127 アプリのバックアップデータの検査 (Inspecting an App's Backup Data)](techniques/android/MASTG-TECH-0127.md)
    - [MASTG-TECH-0128 アプリデータのバックアップと復元の実行 (Performing a Backup and Restore of App Data)](techniques/android/MASTG-TECH-0128.md)
    - [MASTG-TECH-0129 実行時に Android の依存関係を検証する (Verifying Android Dependencies at Runtime)](techniques/android/MASTG-TECH-0129.md)
    - [MASTG-TECH-0130 SBOM を作成することによる Android の依存関係のソフトウェアコンポジション解析 (Software Composition Analysis (SCA) of Android Dependencies by Creating a SBOM)](techniques/android/MASTG-TECH-0130.md)
  ...
  - iOS
    ...
    - [MASTG-TECH-0057 インストール済みアプリの一覧表示 (Listing Installed Apps)](techniques/ios/MASTG-TECH-0057.md)
    - [MASTG-TECH-0060 システムログの監視 (Monitoring System Logs)](techniques/ios/MASTG-TECH-0060.md)
    - [MASTG-TECH-0062 基本的なネットワークモニタリング/スニッフィング (Basic Network Monitoring/Sniffing)](techniques/ios/MASTG-TECH-0062.md)
    - [MASTG-TECH-0065 iOS アプリのリバースエンジニアリング (Reverse Engineering iOS Apps)](techniques/ios/MASTG-TECH-0065.md)
    - [MASTG-TECH-0066 iOS での静的解析 (Static Analysis on iOS)](techniques/ios/MASTG-TECH-0066.md)
    - [MASTG-TECH-0067 iOS での動的解析 (Dynamic Analysis on iOS)](techniques/ios/MASTG-TECH-0067.md)
    - [MASTG-TECH-0068 ネイティブコードの逆アセンブル (Disassembling Native Code)](techniques/ios/MASTG-TECH-0068.md)
    - [MASTG-TECH-0069 ネイティブコードの逆コンパイル (Decompiling Native Code)](techniques/ios/MASTG-TECH-0069.md)
    - [MASTG-TECH-0071 文字列の取得 (Retrieving Strings)](techniques/ios/MASTG-TECH-0071.md)
    - [MASTG-TECH-0072 相互参照の取得 (Retrieving Cross References)](techniques/ios/MASTG-TECH-0072.md)
    - [MASTG-TECH-0073 情報収集 - API 使用 (Information Gathering - API Usage)](techniques/ios/MASTG-TECH-0073.md)
    - [MASTG-TECH-0074 情報収集 - ネットワーク通信 (Information Gathering - Network Communication)](techniques/ios/MASTG-TECH-0074.md)
    - [MASTG-TECH-0075 逆コンパイルされた Objective-C と Swift コードのレビュー (Reviewing Decompiled Objective-C and Swift Code)](techniques/ios/MASTG-TECH-0075.md)
    - [MASTG-TECH-0078 自動静的解析 (Automated Static Analysis)](techniques/ios/MASTG-TECH-0078.md)
    - [MASTG-TECH-0080 オープンファイルの取得 (Get Open Files)](techniques/ios/MASTG-TECH-0080.md)
    - [MASTG-TECH-0081 オープンコネクションの取得 (Get Open Connections)](techniques/ios/MASTG-TECH-0081.md)
    - [MASTG-TECH-0083 TBD](techniques/ios/MASTG-TECH-0083.md)
...
- [ツール一覧](tools.md)
  ...
  - Android
    ...
    - [MASTG-TOOL-0029 objection (Android)](tools/android/MASTG-TOOL-0029.md)
  ...
  - iOS
    ...
    - [MASTG-TOOL-0040 MobSF (iOS)](tools/ios/MASTG-TOOL-0040.md)
    ...
    - [MASTG-TOOL-0073 radare2 (iOS)](tools/ios/MASTG-TOOL-0073.md)
    - [MASTG-TOOL-0074 objection (iOS)](tools/ios/MASTG-TOOL-0074.md)
  ...
  - Network
    ...
    - [MASTG-TOOL-0079 ZAP (Zed Attack Proxy)](tools/network/MASTG-TOOL-0079.md)
