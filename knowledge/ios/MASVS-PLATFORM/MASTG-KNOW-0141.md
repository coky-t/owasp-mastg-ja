...
# MASTG-KNOW-0141 カスタムキーボード (Custom Keyboards)

[カスタムキーボード](https://developer.apple.com/documentation/uikit/creating-a-custom-keyboard) は、デバイス上のすべてのアプリにわたってシステムキーボードを置き換えるアプリ拡張 ([App Extension (App extensions)](https://github.com/coky-t/owasp-mastg-ja/blob/master/knowledge/ios/MASVS-PLATFORM/MASTG-KNOW-0082.md) を参照) です。ユーザーはそれを含むアプリを通じてインストールを行い、明示的に **設定** (**一般 > キーボード > キーボード**) で有効にする必要があります。
