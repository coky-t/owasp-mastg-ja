...
[難読化 (Obfuscation)](https://github.com/coky-t/owasp-mastg-ja/blob/master/knowledge/generic/MASVS-RESILIENCE/MASTG-KNOW-0111.md) では一般的にモバイルアプリで使用できるよく知られた難読化技法をいくつか紹介しています。
...
![](../../../.gitbook/assets/control-flow-flattening.png)
...
iOS の難読化技法については記事 ["Protecting Million-User iOS Apps with Obfuscation: Motivations, Pitfalls, and Experience"](https://faculty.ist.psu.edu/wu/papers/obf-ii.pdf) をご覧ください。
