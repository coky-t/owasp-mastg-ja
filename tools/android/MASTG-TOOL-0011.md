...
apktool を使用して、デコードしたリソースをバイナリ APK/JAR に再パッケージすることもできます。詳細と実例については、techniques の [アプリパッケージの探索](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/android/MASTG-TECH-0007.md) および [再パッケージと再署名](../../techniques/android/MASTG-TECH-0039.md) を参照してください。
