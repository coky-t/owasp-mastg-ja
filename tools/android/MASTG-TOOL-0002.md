...
詳細については [MobSF ドキュメント](https://github.com/MobSF/Mobile-Security-Framework-MobSF/wiki/1.-Documentation) を参照してください。
