...
cdxgen は、ほとんどのアプリケーションとコンテナイメージのソフトウェア部品表 (SBOM) を一つのコマンドで生成できます。iOS では SwiftPM、Android では Maven をサポートしています。生成された SBOM は [dependency-track](MASTG-TOOL-0132.md) などの解析ツールに送信できます。
