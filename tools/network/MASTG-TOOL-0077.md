...
詳細については [傍受プロキシの設定 (Setting Up an Interception Proxy)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/android/MASTG-TECH-0011.md) (Android) および [傍受プロキシの設定 (Setting Up an Interception Proxy)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/ios/MASTG-TECH-0063.md) (iOS) を参照してください。
