...
このテストは、アプリがテキスト入力フィールドを適切に設定して、パスワードや個人データなどの機密情報をキーボードがキャッシュ ([キーボードキャッシュ (Keyboard Cache)](../../../knowledge/android/MASVS-STORAGE/MASTG-KNOW-0055.md)) しないことを検証します。
