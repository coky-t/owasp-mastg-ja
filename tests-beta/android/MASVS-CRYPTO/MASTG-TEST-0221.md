...
[逆コンパイルされた Java コードのレビュー (Reviewing Decompiled Java Code)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/android/MASTG-TECH-0023.md) を使用して、報告された各コード箇所を検査し、そのアルゴリズムが機密データを保護するためのセキュリティ関連のコンテキストで使用されているかどうかを判断します。
