...
2. [傍受プロキシの設定 (Setting Up an Interception Proxy)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/android/MASTG-TECH-0011.md) を使用して、傍受プロキシを設定し、通信を傍受します。

### 結果

出力には傍受したトラフィックキャプチャを含む可能性があります。

### 評価

関連するドメインのいずれかが傍受したトラフィックキャプチャに現れる場合、そのテストケースは不合格です。
