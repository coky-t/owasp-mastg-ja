---
title: >-
  ユーザー提供の CA を信頼する古い Android バージョン (Outdated Android Version Allowing Trust in
  User-Provided CAs)
platform: android
id: MASTG-TEST-0285
type:
...
3. [AndroidManifest の解析 (Analyzing the AndroidManifest)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/android/MASTG-TECH-0150.md) を使用して、`<uses-sdk>` 要素から `minSdkVersion` 属性の値を読み取ります。
