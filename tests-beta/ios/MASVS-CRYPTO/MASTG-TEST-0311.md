...
# MASTG-TEST-0311 安全でないランダム API の使用 (Insecure Random API Usage)
...
使用がセキュリティ関連かどうかを判断することは状況によって異なるため、[逆アセンブルされた Objective-C と Swift のコードをレビューする (Reviewing Disassembled Objective-C and Swift Code)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/ios/MASTG-TECH-0076.md) を使用して報告された各コード箇所を検査します。
