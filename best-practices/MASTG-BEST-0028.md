...
# MASTG-BEST-0028 WebView キャッシュをクリーンアップする (WebViews Cache Cleanup)
...
[WebView (WebViews)](https://github.com/coky-t/owasp-mastg-ja/blob/master/knowledge/android/MASVS-PLATFORM/MASTG-KNOW-0018.md) では、WebView で使用されるさまざまなストレージ領域について説明しています。
