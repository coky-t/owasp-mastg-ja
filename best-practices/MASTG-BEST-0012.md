...
* 信頼できないコンテンツへの JavaScript ブリッジの露出を避けます ([従来の JavaScript ブリッジよりもオリジンスコープメッセージングを優先する (Prefer Origin Scoped Messaging Over Legacy JavaScript Bridges)](https://github.com/coky-t/owasp-mastg-ja/blob/master/best-practices/MASTG-BEST-0035.md))。
