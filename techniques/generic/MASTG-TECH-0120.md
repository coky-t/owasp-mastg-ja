---
title: >-
  傍受プロキシを使用して HTTP トラフィックを傍受する (Intercepting HTTP Traffic Using an Interception
  Proxy)
platform: generic
---
...
* Android: [傍受プロキシの設定 (Setting Up an Interception Proxy)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/android/MASTG-TECH-0011.md) 参照
* iOS: [傍受プロキシの設定 (Setting Up an Interception Proxy)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/ios/MASTG-TECH-0063.md) 参照
