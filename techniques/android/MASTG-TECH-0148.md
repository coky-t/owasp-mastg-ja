...
# MASTG-TECH-0148 Android コンテンツプロバイダとのやり取り (Interacting with Android ContentProviders)

Android の `ContentProvider` の概要 (URI 構造、アクセス制御、クエリ処理など) については [Android コンテンツプロバイダ (Android ContentProvider)](https://github.com/coky-t/owasp-mastg-ja/blob/master/knowledge/android/MASVS-CODE/MASTG-KNOW-0117.md) を参照してください。
