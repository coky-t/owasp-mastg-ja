...
# MASTG-TECH-0145 XAPK ファイルの扱い (Working with XAPK Files)
...
Android アプリの逆コンパイルの詳細については [Java コードの逆コンパイル (Decompiling Java Code)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/android/MASTG-TECH-0017.md) を参照してください。
