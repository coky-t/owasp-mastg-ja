...
# MASTG-TECH-0143 WebView でのファイルシステム操作の監視 (Monitor File System Operations in WebViews)
...
* または [実行トレース (Execution Tracing)](https://github.com/coky-t/owasp-mastg-ja/blob/master/techniques/android/MASTG-TECH-0032.md) を使用して (例: `strace -p <app_pid>`)、そのディレクトリのファイル操作を監視します。
