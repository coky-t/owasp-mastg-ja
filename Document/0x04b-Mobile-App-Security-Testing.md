...
[OWASP MASVS](https://mas.owasp.org/MASVS/0x01-Foreword "OWASP MASVS") を使用し、リスク評価フェーズに基づいてモバイルアプリのセキュリティ要件を決定します。特にアジャイルプロジェクトでは、機能とデータクラスが追加された際には要件をレビューすることを繰り返すことが一般的です。
